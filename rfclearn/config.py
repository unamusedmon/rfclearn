...
HEADER_REFERENCES: dict[int, dict[str, object]] = {
    ...
    791: {
        ...
        "fields": [
            ...
            ("Type of Service", 8, "QoS byte including precedence (3 bits), D/T/R flags, and 2 reserved bits; odd markings can indicate tunneling, policy abuse, or legacy stack artifacts."),
    ...
    793: {
        ...
        "fields": [
            ...
            ("Reserved", 3, "Should be zero; non-zero reserved bits often indicate crafted or evasive traffic."),
            ("TCP Flags", 9, "SYN/ACK/RST/FIN combinations; watch for illegal flag combos, floods, and RST injection."),
